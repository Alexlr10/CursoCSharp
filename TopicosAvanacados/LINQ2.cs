...
namespace CursoCSharp.TopicosAvanacados {
    class LINQ2 {
        public static void Executar() {
            ...
            if(sicrano == null) {
                ...
                var outraAna = alunos.LastOrDefault(
                    aluno => aluno.Nome.Equals("Ana"));
                Console.WriteLine(outraAna.Nota);

                var exemplosSkip = alunos.Skip(1).Take(3);
                foreach(var item in exemplosSkip) {
                ...
                var mediaAprovados = alunos.Where(a => a.Nota >=7)
